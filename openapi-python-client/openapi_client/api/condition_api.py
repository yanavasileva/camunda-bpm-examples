...
class ConditionApi(object):
    ...
    def evaluate_condition(self, **kwargs):  # noqa: E501
        """evaluate_condition  # noqa: E501
        ...
        >>> thread = api.evaluate_condition(async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param EvaluationConditionDto evaluation_condition_dto:
        ...
        return self.evaluate_condition_with_http_info(**kwargs)  # noqa: E501

    def evaluate_condition_with_http_info(self, **kwargs):  # noqa: E501
        """evaluate_condition  # noqa: E501

        Triggers evaluation of conditions for conditional start event(s).  Internally this maps to the engines condition evaluation builder method ConditionEvaluationBuilder#evaluateStartConditions().  For more information see the [Conditional Start Events](https://docs.camunda.org/manual/7.13/reference/bpmn20/events/conditional-events/#conditional-start-event) section of the [BPMN 2.0 Implementation Reference](https://docs.camunda.org/manual/7.13/reference/bpmn20/).  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.evaluate_condition_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method evaluate_condition" % key
                )
        ...
        body_params = None
        if 'evaluation_condition_dto' in local_var_params:
            body_params = local_var_params['evaluation_condition_dto']
        # HTTP header `Accept`
