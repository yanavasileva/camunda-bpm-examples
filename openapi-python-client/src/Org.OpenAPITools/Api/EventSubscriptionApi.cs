...
namespace Org.OpenAPITools.Api
{
    ...
    public interface IEventSubscriptionApi : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ApiResponse<List<EventSubscriptionDto>>> GetEventSubscriptionsAsyncWithHttpInfo (string eventSubscriptionId = default(string), string eventName = default(string), string eventType = default(string), string executionId = default(string), string processInstanceId = default(string), string activityId = default(string), string tenantIdIn = default(string), bool? withoutTenantId = default(bool?), bool? includeEventSubscriptionsWithoutTenantId = default(bool?), string sortBy = default(string), string sortOrder = default(string), int? firstResult = default(int?), int? maxResults = default(int?));
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
    ...
    public partial class EventSubscriptionApi : IEventSubscriptionApi
    {
        ...
        /// <returns></returns>
        public EventSubscriptionApi(Org.OpenAPITools.Client.Configuration configuration = null)
        {
        ...
        /// <param name="maxResults">Pagination of results. Specifies the maximum number of results to return. Will return less results if there are no more results left. (optional)</param>
        /// <returns>Task of ApiResponse (List&lt;EventSubscriptionDto&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<EventSubscriptionDto>>> GetEventSubscriptionsAsyncWithHttpInfo (string eventSubscriptionId = default(string), string eventName = default(string), string eventType = default(string), string executionId = default(string), string processInstanceId = default(string), string activityId = default(string), string tenantIdIn = default(string), bool? withoutTenantId = default(bool?), bool? includeEventSubscriptionsWithoutTenantId = default(bool?), string sortBy = default(string), string sortOrder = default(string), int? firstResult = default(int?), int? maxResults = default(int?))
        {
