...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class ProcessDefinitionDto :  IEquatable<ProcessDefinitionDto>, IValidatableObject
    {
        ...
        /// <param name="historyTimeToLive">History time to live value of the process definition. Is used within [History cleanup](https://docs.camunda.org/manual/7.13/user-guide/process-engine/history/#history-cleanup)..</param>
        ...
        /// </summary>
        /// <value>History time to live value of the process definition. Is used within [History cleanup](https://docs.camunda.org/manual/7.13/user-guide/process-engine/history/#history-cleanup).</value>
        ...
        [DataMember(Name="startableInTasklist", EmitDefaultValue=false)]
