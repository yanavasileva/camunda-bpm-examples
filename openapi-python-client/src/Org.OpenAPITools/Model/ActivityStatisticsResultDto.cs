...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ActivityStatisticsResultDto :  IEquatable<ActivityStatisticsResultDto>, IValidatableObject
    {
        /// <summary>
        ...
        public ActivityStatisticsResultDto(string id = default(string), int instances = default(int), int failedJobs = default(int), List<IncidentStatisticsResultDto> incidents = default(List<IncidentStatisticsResultDto>))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as ActivityStatisticsResultDto);
        }

        /// <summary>
        /// Returns true if ActivityStatisticsResultDto instances are equal
        /// </summary>
        /// <param name="input">Instance of ActivityStatisticsResultDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ActivityStatisticsResultDto input)
        {
            if (input == null)
                return false;
