...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProcessInstanceQueryDtoSorting :  IEquatable<ProcessInstanceQueryDtoSorting>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ProcessInstanceQueryDtoSorting" /> class.
        /// </summary>
        ...
        public ProcessInstanceQueryDtoSorting(SortByEnum? sortBy = default(SortByEnum?), SortOrderEnum? sortOrder = default(SortOrderEnum?))
        {
            this.SortBy = sortBy;
        ...
        {
            return this.Equals(input as ProcessInstanceQueryDtoSorting);
        }

        /// <summary>
        /// Returns true if ProcessInstanceQueryDtoSorting instances are equal
        /// </summary>
        /// <param name="input">Instance of ProcessInstanceQueryDtoSorting to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProcessInstanceQueryDtoSorting input)
        {
            if (input == null)
                return false;
