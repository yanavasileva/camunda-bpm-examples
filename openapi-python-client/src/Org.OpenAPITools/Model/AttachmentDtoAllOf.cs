...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class AttachmentDtoAllOf :  IEquatable<AttachmentDtoAllOf>, IValidatableObject
    {
        ...
        public AttachmentDtoAllOf(string id = default(string), string name = default(string), string description = default(string), string taskId = default(string), string type = default(string), string url = default(string), DateTime createTime = default(DateTime), DateTime? removalTime = default(DateTime?), string rootProcessInstanceId = default(string))
        {
