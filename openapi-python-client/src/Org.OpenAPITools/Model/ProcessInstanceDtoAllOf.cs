...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProcessInstanceDtoAllOf :  IEquatable<ProcessInstanceDtoAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProcessInstanceDtoAllOf" /> class.
        /// </summary>
        ...
        public ProcessInstanceDtoAllOf(string id = default(string), string definitionId = default(string), string businessKey = default(string), string caseInstanceId = default(string), bool ended = default(bool), bool suspended = default(bool), string tenantId = default(string))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as ProcessInstanceDtoAllOf);
        }

        /// <summary>
        /// Returns true if ProcessInstanceDtoAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ProcessInstanceDtoAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProcessInstanceDtoAllOf input)
        {
            if (input == null)
                return false;
