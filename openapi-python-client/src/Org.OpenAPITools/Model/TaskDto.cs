...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class TaskDto :  IEquatable<TaskDto>, IValidatableObject
    {
        ...
        /// <param name="created">The date the task was created on. [Default format](https://docs.camunda.org/manual/7.13/reference/rest/overview/date-format/) &#x60;yyyy-MM-dd&#39;T&#39;HH:mm:ss.SSSZ&#x60;..</param>
        /// <param name="due">The task&#39;s due date. [Default format](https://docs.camunda.org/manual/7.13/reference/rest/overview/date-format/) &#x60;yyyy-MM-dd&#39;T&#39;HH:mm:ss.SSSZ&#x60;..</param>
        /// <param name="followUp">The follow-up date for the task. [Default format](https://docs.camunda.org/manual/7.13/reference/rest/overview/date-format/) &#x60;yyyy-MM-dd&#39;T&#39;HH:mm:ss.SSSZ&#x60;..</param>
        ...
        public TaskDto(string id = default(string), string name = default(string), string assignee = default(string), string owner = default(string), DateTime created = default(DateTime), DateTime? due = default(DateTime?), DateTime? followUp = default(DateTime?), DelegationStateEnum? delegationState = default(DelegationStateEnum?), string description = default(string), string executionId = default(string), string parentTaskId = default(string), int? priority = default(int?), string processDefinitionId = default(string), string processInstanceId = default(string), string caseExecutionId = default(string), string caseDefinitionId = default(string), string caseInstanceId = default(string), string taskDefinitionKey = default(string), bool? suspended = default(bool?), string formKey = default(string), string tenantId = default(string))
        {
            this.Due = due;
        ...
        /// </summary>
        /// <value>The date the task was created on. [Default format](https://docs.camunda.org/manual/7.13/reference/rest/overview/date-format/) &#x60;yyyy-MM-dd&#39;T&#39;HH:mm:ss.SSSZ&#x60;.</value>
        ...
        /// </summary>
        /// <value>The task&#39;s due date. [Default format](https://docs.camunda.org/manual/7.13/reference/rest/overview/date-format/) &#x60;yyyy-MM-dd&#39;T&#39;HH:mm:ss.SSSZ&#x60;.</value>
        ...
        /// </summary>
        /// <value>The follow-up date for the task. [Default format](https://docs.camunda.org/manual/7.13/reference/rest/overview/date-format/) &#x60;yyyy-MM-dd&#39;T&#39;HH:mm:ss.SSSZ&#x60;.</value>
