...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class CaseDefinitionDto :  IEquatable<CaseDefinitionDto>, IValidatableObject
    {
        ...
        /// <param name="historyTimeToLive">History time to live value of the case definition. Is used within [History cleanup](https://docs.camunda.org/manual/7.13/user-guide/process-engine/history/#history-cleanup)..</param>
        ...
        /// </summary>
        /// <value>History time to live value of the case definition. Is used within [History cleanup](https://docs.camunda.org/manual/7.13/user-guide/process-engine/history/#history-cleanup).</value>
