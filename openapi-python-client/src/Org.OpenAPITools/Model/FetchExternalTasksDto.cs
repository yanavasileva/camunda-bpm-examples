...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class FetchExternalTasksDto :  IEquatable<FetchExternalTasksDto>, IValidatableObject
    {
        ...
        /// <param name="asyncResponseTimeout">The [Long Polling](https://docs.camunda.org/manual/7.13/user-guide/process-engine/external-tasks/#long-polling-to-fetch-and-lock-external-tasks) timeout in milliseconds.  **Note:** The value cannot be set larger than 1.800.000 milliseconds (corresponds to 30 minutes)..</param>
        ...
        public FetchExternalTasksDto(string workerId = default(string), int? maxTasks = default(int?), bool? usePriority = default(bool?), long? asyncResponseTimeout = default(long?), List<FetchExternalTaskTopicDto> topics = default(List<FetchExternalTaskTopicDto>))
        {
            ...
            if (workerId == null)
            {
                throw new InvalidDataException("workerId is a required property for FetchExternalTasksDto and cannot be null");
            }
            else
            {
            ...
            if (maxTasks == null)
            {
                throw new InvalidDataException("maxTasks is a required property for FetchExternalTasksDto and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="maxTasks", EmitDefaultValue=true)]
        ...
        /// </summary>
        /// <value>The [Long Polling](https://docs.camunda.org/manual/7.13/user-guide/process-engine/external-tasks/#long-polling-to-fetch-and-lock-external-tasks) timeout in milliseconds.  **Note:** The value cannot be set larger than 1.800.000 milliseconds (corresponds to 30 minutes).</value>
