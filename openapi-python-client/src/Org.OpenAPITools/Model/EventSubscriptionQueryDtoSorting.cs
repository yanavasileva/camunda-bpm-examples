...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EventSubscriptionQueryDtoSorting :  IEquatable<EventSubscriptionQueryDtoSorting>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EventSubscriptionQueryDtoSorting" /> class.
        /// </summary>
        ...
        public EventSubscriptionQueryDtoSorting(SortByEnum? sortBy = default(SortByEnum?), SortOrderEnum? sortOrder = default(SortOrderEnum?))
        {
            this.SortBy = sortBy;
        ...
        {
            return this.Equals(input as EventSubscriptionQueryDtoSorting);
        }

        /// <summary>
        /// Returns true if EventSubscriptionQueryDtoSorting instances are equal
        /// </summary>
        /// <param name="input">Instance of EventSubscriptionQueryDtoSorting to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EventSubscriptionQueryDtoSorting input)
        {
            if (input == null)
                return false;
