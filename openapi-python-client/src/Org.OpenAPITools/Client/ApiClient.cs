...
namespace Org.OpenAPITools.Client
{
    ...
    public partial class ApiClient
    {
        ...
        public ApiClient()
        {
            ...
            RestClient = new RestClient("http://localhost:8080/engine-rest");
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="ApiClient" /> class
        /// with default base path (http://localhost:8080/engine-rest).
        /// </summary>
        ...
        public ApiClient(String basePath = "http://localhost:8080/engine-rest")
        {
