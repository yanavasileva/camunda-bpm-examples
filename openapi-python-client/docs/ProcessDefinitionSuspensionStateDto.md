...
**process_definition_id** | **str** | The id of the process definitions to activate or suspend. | [optional] 
**process_definition_key** | **str** |  The key of the process definitions to activate or suspend. | [optional] 
